...
async function start() {
  ...
  /**
   * The following example demonstrates the ways to consume data from the V2 (Pro) WebSockets. For the V1 examples, ws-futures-v1-public.ts
   */
  try {
    // Optional: await a connection to be ready before subscribing (this is not necessary)
    // await client.connect('futuresPublicV2');
    ...
    client.subscribe(klineRequest, 'futuresPublicV2');
