const { FuturesClient } = require('kucoin-api');
  ...
  // ENDPOINT: api/v1/broker/api/rebase/download
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/kucoin-api/blob/master/src/FuturesClient.ts#L588
...
client.getBrokerRebateOrderDownloadLink(params)
  .then((response) => {
