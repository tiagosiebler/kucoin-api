const { FuturesClient } = require('kucoin-api');
  ...
  // ENDPOINT: api/v1/interest/query
  // METHOD: GET
  // PUBLIC: YES
  // Link to function: https://github.com/tiagosiebler/kucoin-api/blob/master/src/FuturesClient.ts#L255
...
client.getInterestRates(params)
  .then((response) => {
