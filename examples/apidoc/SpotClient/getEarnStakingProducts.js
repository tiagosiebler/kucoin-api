const { SpotClient } = require('kucoin-api');
  ...
  // ENDPOINT: api/v1/earn/staking/products
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/kucoin-api/blob/master/src/SpotClient.ts#L1443
...
client.getEarnStakingProducts(params)
  .then((response) => {
