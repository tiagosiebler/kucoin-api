const { SpotClient } = require('kucoin-api');
  ...
  // ENDPOINT: api/v1/otc-loan/accounts
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/kucoin-api/blob/master/src/SpotClient.ts#L1479
...
client.getOtcLoanAccounts(params)
  .then((response) => {
