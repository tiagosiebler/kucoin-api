const { SpotClient } = require('kucoin-api');
  ...
  // ENDPOINT: api/v1/earn/redeem-preview
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/kucoin-api/blob/master/src/SpotClient.ts#L1445
...
client.getEarnRedeemPreview(params)
  .then((response) => {
